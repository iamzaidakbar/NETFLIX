...
function App() {
    ...
    const homeVideos = [
        ...
        },
        {
            ...
            src:"http://youtu.be/IN5TD4VRcSM?t=2",
    ...
    return (
        ...
        <div className="app">
            <ApiState>
                <Router>
                    <div id="homeVideo">
                        <VideoCaption title={homeVideos[randomNumber].name} description={homeVideos[randomNumber].description} />
                        <VideoPlayer
                            ...
                            volume={volume}
                        />
                        <button onClick={handleClick} className="btn border transparent px-2 py-1 mute-btn">
